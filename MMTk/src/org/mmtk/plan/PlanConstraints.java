...
@Uninterruptible public abstract class PlanConstraints {
  ...
  public boolean needsObjectReferenceWriteBarrier() { return Plan.WRITE_BARRIERS_ON; }

  /** @return {@code true} if this Plan requires read barriers on object references. */
  public boolean needsObjectReferenceReadBarrier() { return Plan.READ_BARRIERS_ON; }

  /** @return {@code true} if this Plan requires non-heap write barriers on object references. */
  public boolean needsObjectReferenceNonHeapWriteBarrier() { return Plan.WRITE_BARRIERS_ON;}
