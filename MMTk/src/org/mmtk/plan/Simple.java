...
public abstract class Simple extends Plan {
  ...
  public static final short TI_INITIATE         = Phase.createSimple("TI-initiate");
  public static final short TI_PREPARE          = Phase.createSimple("TI-prepare");
  public static final short TI_PREPARE_STACKS   = Phase.createSimple("TI-prepare-stacks");
  public static final short TI_STACK_ROOTS      = Phase.createSimple("TI-stacks");
  public static final short TI_ROOTS            = Phase.createSimple("TI-root");
  public static final short TI_CLOSURE          = Phase.createSimple("TI-closure");
  public static final short TI_RELEASE          = Phase.createSimple("TI-release");
  public static final short TI_COMPLETE         = Phase.createSimple("TI-complete");
  ...
  public short threadIndependentCollection = Phase.createComplex("threadIndependent", null,
      //Phase.scheduleMutator   (TI_INITIATE),
      Phase.scheduleCollector (TI_INITIATE),
      Phase.scheduleMutator   (TI_PREPARE),
      Phase.scheduleCollector (TI_PREPARE),
      Phase.scheduleMutator   (TI_PREPARE_STACKS),
      Phase.scheduleCollector (TI_STACK_ROOTS),
      Phase.scheduleCollector (TI_CLOSURE),
      Phase.scheduleMutator   (TI_RELEASE),
      Phase.scheduleCollector (TI_RELEASE),
      Phase.scheduleMutator   (TI_COMPLETE),
      Phase.scheduleCollector (TI_COMPLETE));
