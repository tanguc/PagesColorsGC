...
@Uninterruptible class Deque {
  ...
  @NoInstrument
  @Inline
  protected final Offset bufferOffsetNI(Address buf) {
    return buf.toWord().and(BUFFER_MASK).toOffset();
  }
  @Inline
  ...
  @Inline
  @NoInstrument
  protected final Address bufferStartNI(Address buf) {
    return buf.toWord().and(BUFFER_MASK.not()).toAddress();
  }
  @Inline
  ...
  @Inline
  @NoInstrument
  protected final Address bufferFirstNI(Address buf) {
    return bufferStartNI(buf);
  }
  @Inline
  ...
  @Inline
  @NoInstrument
  protected final Offset bufferLastOffsetNI(int arity) {
    return Offset.fromIntZeroExtend(USABLE_BUFFER_BYTES - BYTES_IN_ADDRESS -
        (USABLE_BUFFER_BYTES % (arity << LOG_BYTES_IN_ADDRESS)));
  }
