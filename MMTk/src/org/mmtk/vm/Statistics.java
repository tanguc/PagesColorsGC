...
public abstract class Statistics {
  ...
  public abstract void logGC(int gc, long startTime, int pagesFreed, long nanosElapsed);
  public abstract void logTIGC(int threadID, int tigc, long startTime, int pagesFreed, long nanosElapsed, int liveWhite, long remsetGreyEntries, long remsetBlackEntries, long reclaimedCellsSize);
  public abstract void logThreadCounterOverflow(int threadID, int cId, int overflowvalue);
}
