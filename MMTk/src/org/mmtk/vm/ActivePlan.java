...
@Uninterruptible public abstract class ActivePlan {
  ...
  public abstract int getNumberOfActiveThreads();
  public abstract int getNumberOfThreads();
  public abstract int getThreadID();
  public abstract boolean fullyBooted();
  public abstract boolean isBenchmarkThread(int threadID);
  //public abstract boolean threadBlocked(int threadID);
  public abstract void yield();
  public abstract int getGlobaliserThreadID();
  
  public abstract MutatorContext getThreadById(int threadID);
  //public abstract int maxSupportedRequestingThreads();
  
  public abstract void readAdviceFile(String file);
  public abstract int getBinding(int threadID);
  public abstract void setBinding(int cpuid);
}
