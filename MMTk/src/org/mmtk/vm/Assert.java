...
@Uninterruptible public abstract class Assert {
  ...
  public abstract void failNI(String message);
  public abstract void dumpStackNI();
  public abstract void logLong(long v);
  public abstract void logLongln(long v);
  public abstract void logInt(int v);
  public abstract void logStr(String v);
  public abstract void logHex(Address v);
  public abstract void logIntln(int v);
  public abstract void logStrln(String v);
  public abstract void logHexln(Address v);
  public abstract void assertGlobaliseControl();
  public abstract void assertGlobaliseActiveControl(int threadID);
}
