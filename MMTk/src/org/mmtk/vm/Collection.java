...
@Uninterruptible public abstract class Collection {
  ...
  @Unpreemptible
  public abstract void stopGlobaliserThread();
  ...
  @Unpreemptible
  public abstract void resumeGlobaliserThread();
  ...
  @Interruptible
  public abstract void spawnTICollectorContext(CollectorContext context);
  public abstract int getThreads();
  @Unpreemptible
  public abstract void blockForTIGC();
  @Unpreemptible
  public abstract void waitUntilMutatorBlockedForTIGC(int id);
  @Unpreemptible
  public abstract void resumeMutatorFromTIGC(int threadID);
}
