...
public abstract class ObjectModel {
  ...
  public abstract int getType(ObjectReference o);
  
  public abstract void setGlobaliseBit(ObjectReference o);
  public abstract void setAllocatingThreadAndColour(ObjectReference o, int threadID, int colour);
  public abstract void setBootThreadAndColour(ObjectReference o, int threadID, int colour);
  public abstract void setColour(ObjectReference o, int colour);
  public abstract int getAllocatingThread(ObjectReference o);
  public abstract int getOriginalAllocatingThread(ObjectReference o);
  public abstract int getColour(ObjectReference o);
  public abstract int[] getChildren(ObjectReference o);
  
  public abstract void setAllocID(ObjectReference o, int threadAllocN);
  public abstract int getAllocID(ObjectReference o);
  public abstract void dumpAllHeaders(ObjectReference o);
  
  public abstract void requestGlobalise(ObjectReference o);
  
  public abstract int getSpaceForObject(ObjectReference o);
  public abstract int getTypeID(ObjectReference o);
  
  public abstract boolean isTIBInvalid(ObjectReference o);
  public abstract boolean isMine(ObjectReference o);
  
  public abstract Address objectToAddress(ObjectReference object);
  public abstract boolean isType(ObjectReference o);
  public abstract boolean isRVMType(ObjectReference o);
}
