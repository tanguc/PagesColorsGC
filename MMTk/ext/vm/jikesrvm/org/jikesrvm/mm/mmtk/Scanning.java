...
public final class Scanning extends org.mmtk.vm.Scanning {
  ...
  @Override
  public void computeThreadRoots(TraceLocal trace, int mutSlot) {
    boolean processCodeLocations = MemoryManagerConstants.MOVES_CODE;
  
    RVMThread thread = RVMThread.threadMonotonically[mutSlot];
    if (VM.VerifyAssertions) VM._assert(thread != null && !thread.isCollectorThread());
