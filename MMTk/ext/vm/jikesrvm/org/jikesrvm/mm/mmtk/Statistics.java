...
public final class Statistics extends org.mmtk.vm.Statistics {
  ...
  public void logGC(int gc, long startTime, int pagesFreed, long nanosElapsed) {
	  sysCall.logGC(RVMThread.getCurrentThreadMonotonicNI(), gc, startTime, pagesFreed, nanosElapsed);
  }
  
  public void logTIGC(int threadID, int tigc, long startTime, int pagesFreed, long nanosElapsed, int liveWhite, long remsetGreyEntries, long remsetBlackEntries, long reclaimedCellsSize) {
	  sysCall.logTIGC(RVMThread.getCurrentThreadMonotonicNI(), threadID, tigc, startTime, pagesFreed, nanosElapsed, liveWhite, remsetGreyEntries, remsetBlackEntries, reclaimedCellsSize);
  }
  
  public void logThreadCounterOverflow(int threadID, int cId, int overflowvalue) {
    sysCall.logThreadCounterOverflow(RVMThread.getCurrentThreadMonotonicNI(), threadID, cId, overflowvalue);
  }
}
