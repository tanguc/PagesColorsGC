...
public final class MemoryManager {
  ...
  @NoInstrument
  @Inline
  public static boolean addressInVMNI(Address address) {
    return Space.isMappedAddressNI(address);
  }
   ...
   */
  @Inline
  public static Object allocateScalar(int size, TIB tib, int allocator, int align, int offset, int site, int advice) {
    ...
    mutator.postAlloc(ObjectReference.fromObject(result), ObjectReference.fromObject(tib), size, allocator, advice);
    return result;
  }
  ...
  public static Object allocateArray(int numElements, int logElementSize, int headerSize, TIB tib, int allocator,
    ...
    return allocateArray(numElements, logElementSize, headerSize, tib, allocator, align, offset, site, Plan.DEFAULT_ADVICE);
  }
  ...
  @Unpreemptible
  public static Object allocateArray(int numElements, int logElementSize, int headerSize, TIB tib, int allocator,
                                     int align, int offset, int site, int advice) {
    ...
    return allocateArrayInternal(numElements, size, tib, allocator, align, offset, site, advice);
  }
