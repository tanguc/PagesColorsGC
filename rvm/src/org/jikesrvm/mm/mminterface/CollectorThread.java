...
public final class CollectorThread extends SystemThread {
  ...
  public CollectorThread(byte[] stack, CollectorContext context) {
    this(stack, context, false);
  }
  
  public CollectorThread(byte[] stack, CollectorContext context, boolean threadIndependent) {
    super(stack, context.getClass().getName() + (threadIndependent ? " <TIGC>" : "") + " [" + nextId + "]");
