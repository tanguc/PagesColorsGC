...
public abstract class RVMType extends AnnotatedElement {
  ...
  private boolean isRVMType = false;
  ...
  protected RVMType(TypeReference typeRef, Class<?> classForType, int dimension, RVMAnnotation[] annotations) {
    ...
    this.isRVMType = typeRef.getNameNI().isRVMaDescriptor();
  ...
  @NoInstrument
  @Uninterruptible
  public final boolean isRVMType() {
    return isRVMType;
  }
  ...
  @Uninterruptible
  @NoInstrument
  public final RVMClass asClassNI() {
    return (RVMClass) this;
  }
  ...
  @Uninterruptible
  @NoInstrument
  public int[] getReferenceOffsetsNI() {
    return referenceOffsets;
  }
}
