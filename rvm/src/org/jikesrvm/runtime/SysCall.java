...
public abstract class SysCall {
  ...
  @SysCallTemplate
  public abstract void sysMonitorEnterDbg(Word monitor);
  @SysCallTemplate
  public abstract void sysMonitorExit(Word monitor);
  @SysCallTemplate
  public abstract void sysMonitorExitDbg(Word monitor);
  @SysCallTemplate
  ...
  @SysCallTemplate
  public abstract void sysMonitorWaitDbg(Word monitor);
  @SysCallTemplate
  public abstract void sysMonitorBroadcastDbg(Word monitor);
  // arithmetic
  @SysCallTemplate
  ...
  @SysCallTemplate
  public abstract void logInt(int v);
  @SysCallTemplate
  public abstract void logLong(long v);
  @SysCallTemplate
  public abstract void logLongln(long v);
  @SysCallTemplate
  public abstract void logChar(char v);
  @SysCallTemplate
  public abstract void logHex(int v);
  @SysCallTemplate
  public abstract void logIntln(int v);
  @SysCallTemplate
  public abstract void logCharln(char v);
  @SysCallTemplate
  public abstract void logln();
  @SysCallTemplate
  public abstract void logHexln(int v);
  @SysCallTemplate
  public abstract void logGC(int tid, int gc, long startTime, int pagesFreed, long nanosElapsed); //boolean isForced, boolean isEmergency, boolean harness, boolean reportLive, long numbersAllocated, long sizeAllocated);
  @SysCallTemplate
  public abstract void logThread(int tid, int monotonicID, int category, int nameLength);
  @SysCallTemplate
  public abstract void logThreadCounter(int tid, int monotonicID, int counterId, int counterValue);
  @SysCallTemplate
  public abstract void logExtraChar(int tid, char v);
  @SysCallTemplate
  public abstract void logSpace(int tid, int spaceID, int lengthOfName);
  @SysCallTemplate
  public abstract void logType(int tid, int typeID, boolean isArray, boolean isPrimitive, boolean hasFinalizer, int nPrimFields, int nRefFields, int nStaticPrimFields, int nStaticRefFields, int lengthofname);
  @SysCallTemplate
  public abstract void logTIGC(int tid, int threadID, int tigc, long startTime, int pagesFreed, long nanosElapsed, int liveWhite, long remsetGreyEntries, long remsetBlackEntries, long reclaimedCellsSize);
  @SysCallTemplate
  public abstract void logThreadCounterOverflow(int tid, int monotonicID, int counterId, int counterOverflowValue);
  @SysCallTemplate
  public abstract void sysSetBind(int cpuId);
  @SysCallTemplate
  public abstract int sysGetBind();
}
