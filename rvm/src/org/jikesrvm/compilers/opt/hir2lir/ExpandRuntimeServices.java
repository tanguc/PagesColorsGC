    ...
    for (Instruction inst = ir.firstInstructionInCodeOrder(); inst != null; inst = next) {
      ...
      switch (opcode) {
        ...
        case NEW_opcode: {
          ...
          IntConstantOperand advice = IRTools.IC(AllocationSite.getAdvice(cls, callSite.getNameNI(), callSite.getDescriptorNI(), inst.bcIndex));
        ...
        case NEW_UNRESOLVED_opcode: {
          ...
          RVMMethod callSite = inst.position.getMethod();
          IntConstantOperand site = IRTools.IC(MemoryManager.getAllocationSite(true));
          IntConstantOperand advice = IRTools.IC(AllocationSite.getAdvice(New.getType(inst).getTypeRef(), callSite.getNameNI(), callSite.getDescriptorNI(), inst.bcIndex));
          Call.mutate3(inst,
                       CALL,
                       New.getClearResult(inst),
                       IRTools.AC(target.getOffset()),
        ...
        case NEWARRAY_opcode: {
          ...
          IntConstantOperand site = IRTools.IC(MemoryManager.getAllocationSite(true));
          IntConstantOperand advice = IRTools.IC(AllocationSite.getAdvice(array.getTypeRef(), callSite.getNameNI(), callSite.getDescriptorNI(), inst.bcIndex));
        ...
        case REF_ASTORE_opcode: {
          if (NEEDS_OBJECT_ASTORE_BARRIER && !ir.method.hasNoInstrumentAnnotation()) {
        ...
        case REF_ALOAD_opcode: {
          if (NEEDS_OBJECT_ALOAD_BARRIER && !ir.method.hasNoInstrumentAnnotation()) {
        ...
        case PUTFIELD_opcode: {
          if (NEEDS_OBJECT_PUTFIELD_BARRIER && !ir.method.hasNoInstrumentAnnotation()) {
        ...
        case GETFIELD_opcode: {
          if (NEEDS_OBJECT_GETFIELD_BARRIER && !ir.method.hasNoInstrumentAnnotation()) {
        ...
        case PUTSTATIC_opcode: {
          if (NEEDS_OBJECT_PUTSTATIC_BARRIER && !ir.method.hasNoInstrumentAnnotation()) {
