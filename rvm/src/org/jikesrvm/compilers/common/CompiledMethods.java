...
public class CompiledMethods {
  ...
  @Uninterruptible
  @NoInstrument
  public static CompiledMethod getCompiledMethodNI(int compiledMethodId) {
    Magic.isync();  // see potential update from other procs
    ...
    int column = compiledMethodId >> LOG_ROW_SIZE;
    return compiledMethods[column][compiledMethodId & ROW_MASK];
  }
