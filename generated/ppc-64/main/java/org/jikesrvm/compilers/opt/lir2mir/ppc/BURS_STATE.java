...
static BURS_TreeNode kids(BURS_TreeNode p, int eruleno, int kidnumber)  { 
	...
	case 1: // stm: r
		...
		break;
	case 241: // r: REF_MOVE(LONG_CONSTANT)
	case 240: // r: REF_MOVE(ADDRESS_CONSTANT)
	...
	case 2: // r: REGISTER
		break;
	case 263: // r: ATTEMPT_ADDR(r,r)
	case 262: // r: PREPARE_ADDR(r,r)
	case 255: // r: LONG_LOAD(r,r)
	case 243: // stm: LONG_IFCMP(r,r)
	case 242: // r: LONG_CMP(r,r)
	case 232: // r: LONG_USHR(r,r)
	case 230: // r: LONG_SHR(r,r)
	case 226: // r: LONG_SHL(r,r)
	case 223: // r: LONG_REM(r,r)
	case 221: // r: LONG_DIV(r,r)
	...
	case 13: // any: OTHER_OPERAND(any,any)
		...
		break;
	case 254: // r: LONG_LOAD(r,REF_MOVE(ADDRESS_CONSTANT))
	case 253: // r: LONG_LOAD(r,INT_CONSTANT)
	case 249: // rz: INT_2ADDRZerExt(r)
	case 248: // rz: INT_2ADDRZerExt(rz)
	case 245: // stm: LONG_IFCMP(r,LONG_CONSTANT)
	case 244: // stm: LONG_IFCMP(r,INT_CONSTANT)
	case 239: // r: LONG_BITS_AS_DOUBLE(r)
	case 238: // r: DOUBLE_AS_LONG_BITS(r)
	case 237: // r: DOUBLE_2LONG(r)
	case 236: // r: FLOAT_2LONG(r)
	case 235: // r: LONG_2INT(r)
	case 234: // rs: INT_2LONG(rs)
	case 233: // rs: INT_2LONG(r)
	case 231: // r: LONG_USHR(r,INT_CONSTANT)
	case 229: // r: LONG_SHR(r,INT_CONSTANT)
	case 225: // r: LONG_SHL(r,INT_CONSTANT)
	case 224: // r: LONG_REM(r,REF_MOVE(INT_CONSTANT))
	case 222: // r: LONG_DIV(r,REF_MOVE(INT_CONSTANT))
	case 219: // r: LONG_MUL(r,INT_CONSTANT)
	...
	case 64: // r: REF_SUB(INT_CONSTANT,r)
		...
		break;
	case 257: // r: LONG_LOAD(REF_ADD(r,INT_CONSTANT),INT_CONSTANT)
	case 250: // rz: INT_2ADDRZerExt(INT_LOAD(r,INT_CONSTANT))
	case 228: // r: LONG_USHR(LONG_SHL(r,INT_CONSTANT),INT_CONSTANT)
	case 227: // r: LONG_SHL(LONG_USHR(r,INT_CONSTANT),INT_CONSTANT)
	...
	case 86: // r: REF_AND(REF_NOT(r),REF_NOT(r))
		...
		break;
	case 259: // stm: LONG_STORE(r,OTHER_OPERAND(r,REF_MOVE(ADDRESS_CONSTANT)))
	case 258: // stm: LONG_STORE(r,OTHER_OPERAND(r,INT_CONSTANT))
	...
	case 87: // r: REF_AND(r,REF_NOT(r))
		...
		if (kidnumber == 1)  return p.child2.child1;
		break;
	case 256: // r: LONG_LOAD(REF_ADD(r,r),INT_CONSTANT)
	case 251: // rz: INT_2ADDRZerExt(INT_LOAD(r,r))
	case 247: // stm: INT_IFCMP(ATTEMPT_ADDR(r,r),INT_CONSTANT)
	case 246: // stm: INT_IFCMP(ATTEMPT_INT(r,r),INT_CONSTANT)
	...
	case 112: // r: FLOAT_ADD(FLOAT_MUL(r,r),r)
		...
		break;
	case 260: // stm: LONG_STORE(r,OTHER_OPERAND(r,r))
	...
	case 165: // stm: BYTE_STORE(INT_2BYTE(r),OTHER_OPERAND(r,r))
		...
		if (kidnumber == 2)  return p.child2.child2;
		break;
	case 261: // stm: LONG_STORE(r,OTHER_OPERAND(REF_ADD(r,INT_CONSTANT),INT_CONSTANT))
	case 175: // stm: INT_STORE(r,OTHER_OPERAND(REF_ADD(r,INT_CONSTANT),INT_CONSTANT))
		if (kidnumber == 0)  return p.child1;
		if (kidnumber == 1)  return p.child2.child1.child1;
		break;
	case 252: // rz: INT_2ADDRZerExt(INT_LOAD(REF_ADD(r,INT_CONSTANT),INT_CONSTANT))
		if (kidnumber == 0)  return p.child1.child1.child1;
		break;
	}
