 ...
 * <p>
 * Note: Boolean options are defined in /home/vagrant/THESIS_SRC/my-tigc/rvm/src-generated/options/BooleanOptions.aos.dat
 *       All other options are defined in /home/vagrant/THESIS_SRC/my-tigc/rvm/src-generated/options/ValueOptions.aos.dat
 ...
 */
  ...
  public static void printHelp(String prefix) {
    ...
    VM.sysWrite("dna                            String  Name of compiler DNA file (default DNA will be used if no name is given).  Discussed in a comment at the head of CompilerDNA.java\n");
    ...
    VM.sysWrite("bulk_compilation_verbosity     int     Control amount of verbosity for bulk compilation (larger means more)\n");
    VM.sysWrite("logging_level                  int     Control amount of event logging (larger means more)\n");
    VM.sysWrite("final_report_level             int     Control amount of info reported on exit (larger means more)\n");
