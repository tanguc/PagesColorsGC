 ...
 * <p>
 * Note: Boolean options are defined in /home/vagrant/THESIS_SRC/my-tigc/rvm/src-generated/options/BooleanOptions.vm.dat
 *       All other options are defined in /home/vagrant/THESIS_SRC/my-tigc/rvm/src-generated/options/ValueOptions.vm.dat
 *       (value, enumeration)
 * <p>
...
@Uninterruptible public class Options extends Configuration {
   ...
   public static int numberCPUs                        = 64; // Max CPUs to use for benchmark threads.
  ...
  public static boolean process(String arg) {
    ...
    if (name.equals("numberCPUs")) {
       numberCPUs = CommandLineArgs.primitiveParseInt(value);
       return true;
     }
  ...
  public static void printHelp() {
    ...
    VM.sysWrite("numberCPUs                     int     Max CPUs to use for benchmark threads.\n");
  ...
  public static void printOptions() {
    ...
    VM.sysWriteln("\tnumberCPUs                     = ",numberCPUs);
