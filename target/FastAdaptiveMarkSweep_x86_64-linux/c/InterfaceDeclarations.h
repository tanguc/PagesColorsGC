...
struct BootRecord {
  ...
  uint32_t    headerPadding3;
   ...
   Address logGCIP;
   Address logThreadIP;
   Address logThreadCounterIP;
   Address logExtraCharIP;
   Address logSpaceIP;
   Address logTypeIP;
   Address logTIGCIP;
   Address logThreadCounterOverflowIP;
   Address sysSetBindIP;
   Address sysGetBindIP;
   ...
   Address sysMonitorEnterDbgIP;
   Address sysMonitorExitIP;
   Address sysMonitorExitDbgIP;
   Address sysMonitorTimedWaitAbsoluteIP;
   Address sysMonitorWaitIP;
   Address sysMonitorWaitDbgIP;
   Address sysMonitorBroadcastIP;
   Address sysMonitorBroadcastDbgIP;
...
extern "C" int sysMonitorBroadcastDbg();
extern "C" int sysMonitorBroadcast();
extern "C" int sysMonitorWaitDbg();
extern "C" int sysMonitorWait();
extern "C" int sysMonitorTimedWaitAbsolute();
extern "C" int sysMonitorExitDbg();
extern "C" int sysMonitorExit();
extern "C" int sysMonitorEnterDbg();
...
extern "C" int sysGetBind();
extern "C" int sysSetBind();
extern "C" int logThreadCounterOverflow();
extern "C" int logTIGC();
extern "C" int logType();
extern "C" int logSpace();
extern "C" int logExtraChar();
extern "C" int logThreadCounter();
extern "C" int logThread();
extern "C" int logGC();
extern "C" int logln();
extern "C" int logHexln();
extern "C" int logCharln();
extern "C" int logIntln();
extern "C" int logHex();
extern "C" int logChar();
extern "C" int logInt();
extern "C" int logLongln();
extern "C" int logLong();
extern "C" void setLinkage(BootRecord* br){
  ...
  br->sysMonitorBroadcastDbgIP = (intptr_t)sysMonitorBroadcastDbg;
  br->sysMonitorBroadcastIP = (intptr_t)sysMonitorBroadcast;
  br->sysMonitorWaitDbgIP = (intptr_t)sysMonitorWaitDbg;
  br->sysMonitorWaitIP = (intptr_t)sysMonitorWait;
  br->sysMonitorTimedWaitAbsoluteIP = (intptr_t)sysMonitorTimedWaitAbsolute;
  br->sysMonitorExitDbgIP = (intptr_t)sysMonitorExitDbg;
  br->sysMonitorExitIP = (intptr_t)sysMonitorExit;
  br->sysMonitorEnterDbgIP = (intptr_t)sysMonitorEnterDbg;
  ...
  br->sysGetBindIP = (intptr_t)sysGetBind;
  br->sysSetBindIP = (intptr_t)sysSetBind;
  br->logThreadCounterOverflowIP = (intptr_t)logThreadCounterOverflow;
  br->logTIGCIP = (intptr_t)logTIGC;
  br->logTypeIP = (intptr_t)logType;
  br->logSpaceIP = (intptr_t)logSpace;
  br->logExtraCharIP = (intptr_t)logExtraChar;
  br->logThreadCounterIP = (intptr_t)logThreadCounter;
  br->logThreadIP = (intptr_t)logThread;
  br->logGCIP = (intptr_t)logGC;
  br->loglnIP = (intptr_t)logln;
  br->logHexlnIP = (intptr_t)logHexln;
  br->logCharlnIP = (intptr_t)logCharln;
  br->logIntlnIP = (intptr_t)logIntln;
  br->logHexIP = (intptr_t)logHex;
  br->logCharIP = (intptr_t)logChar;
  br->logIntIP = (intptr_t)logInt;
  br->logLonglnIP = (intptr_t)logLongln;
  br->logLongIP = (intptr_t)logLong;
}
...
const Offset RVMThread_stack_offset = 0x00000068;
const Offset RVMThread_stackLimit_offset = 0x000000fc;
const Offset RVMThread_exceptionRegisters_offset = 0x0000007c;
const Offset RVMThread_jniEnv_offset = 0x00000094;
const Offset RVMThread_execStatus_offset = 0x000000dc;
...
const Offset Thread_framePointer_offset = 0x00000100;
const Offset Thread_arrayIndexTrapParam_offset = 0x00000108;
