...
extern "C" void
logThreadCounterOverflow(int tid, int monotonicID, int counterId, int counterOFValue) {
  int LOGID = 2147483640;
  int LOGEND = 2147483647;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&monotonicID, sizeof(monotonicID), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&counterId, sizeof(counterId), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&counterOFValue, sizeof(counterOFValue), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logGC(int tid, int gc, long long startTime, int pagesFreed, long long nanosElapsed) {
  int LOGID = 2147483641;
  int LOGEND = 2147483647;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&gc, sizeof(gc), 1, SysDataFile[tid]) != 1) { printf("logGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&startTime, sizeof(startTime), 1, SysDataFile[tid]) != 1) { printf("logGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&pagesFreed, sizeof(pagesFreed), 1, SysDataFile[tid]) != 1) { printf("logGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&nanosElapsed, sizeof(nanosElapsed), 1, SysDataFile[tid]) != 1) { printf("logGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logThread(int tid, int monotonicID, int category, int lengthOfName) {
  int LOGID = 2147483642;
  int LOGEND = 2147483647;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&monotonicID, sizeof(monotonicID), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&category, sizeof(category), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&lengthOfName, sizeof(lengthOfName), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logSpace(int tid, int spaceID, int lengthOfName) {
  int LOGID = 2147483643;
  int LOGEND = 2147483647;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logSpace failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&spaceID, sizeof(spaceID), 1, SysDataFile[tid]) != 1) { printf("logSpace failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&lengthOfName, sizeof(lengthOfName), 1, SysDataFile[tid]) != 1) { printf("logSpace failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logSpace failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logTIGC(int tid, int threadID, int tigc, long long startTime, int pagesFreed, long long nanosElapsed, int liveWhite, long long remsetGreyEntries, long long remsetBlackEntries, long long reclaimedCellsSize) {
  int LOGID = 2147483644;
  int LOGEND = 2147483647;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&threadID, sizeof(threadID), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&tigc, sizeof(tigc), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&startTime, sizeof(startTime), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&pagesFreed, sizeof(pagesFreed), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&nanosElapsed, sizeof(nanosElapsed), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&liveWhite, sizeof(liveWhite), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&remsetGreyEntries, sizeof(remsetGreyEntries), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&remsetBlackEntries, sizeof(remsetBlackEntries), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&reclaimedCellsSize, sizeof(reclaimedCellsSize), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logTIGC failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logType(int tid, int typeID, char isArray, char isPrimitive, char hasFinalizer, int nPrimFields, int nRefFields, int nStaticPrimFields, int nStaticRefFields, int lengthOfName) {
  int LOGID = 2147483645;
  int LOGEND = 2147483647;
  char x = 0xFF;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&typeID, sizeof(typeID), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&isArray, sizeof(isArray), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&isPrimitive, sizeof(isPrimitive), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&hasFinalizer, sizeof(hasFinalizer), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&x, sizeof(x), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&nPrimFields, sizeof(nPrimFields), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&nRefFields, sizeof(nRefFields), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&nStaticPrimFields, sizeof(nStaticPrimFields), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&nStaticRefFields, sizeof(nStaticRefFields), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&lengthOfName, sizeof(lengthOfName), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logType failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logThreadCounter(int tid, int monotonicID, int counterId, int counterValue) {
  int LOGID = 2147483646;
  int LOGEND = 2147483647;
  if (fwrite(&LOGID, sizeof(LOGID), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&monotonicID, sizeof(monotonicID), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&counterId, sizeof(counterId), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&counterValue, sizeof(counterValue), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  if (fwrite(&LOGEND, sizeof(LOGEND), 1, SysDataFile[tid]) != 1) { printf("logThread failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}

extern "C" void
logExtraChar(int tid, char value) {
  if (fwrite(&value, sizeof(value), 1, SysDataFile[tid]) != 1) { printf("logExtraChar failed to fwrite: %d\n", ferror(SysDataFile[tid])); exit(1); }
  int r = fflush(SysDataFile[tid]); if (r != 0) { printf("Failed to flush: %d\n", r); exit(1); }
}
...
extern "C" void
logLong(long long value) {
  printf("%lld", value);
}

extern "C" void
logLongln(long long value) {
  printf("%lld\n", value);
}
...
sysExit(int value)
{
    ...
    for (int i = 0; i < 1024; i++) {
      fflush(SysDataFile[i]);
      if (fclose(SysDataFile[i]) != 0) {
        printf("Couldn't close file %d", i);
      }
    }
    fflush(stdout);
...
sysGetBind() {
	...
	if (result != 0) {
    	printf("%s: %d\n", "Error getting sysbind", result);
    }
	
	if (CPU_COUNT(&cpuset) > 1) {
		//printf("%s\n", "CPU_COUNT is greater than one");
		//exit(1);
		return -1;
	}
    
    for (int i = 0; i < sysNumProcessors(); i++) {
...
sysMonitorCreate()
{
    ...
    monitor->checkword_start = 1234567;
    pthread_mutex_init(&monitor->mutex, NULL);
    pthread_cond_init(&monitor->cond, NULL);
    monitor->checkword_end = 7654321;
#endif
    return (Word)monitor;
}
...
#else
    vmmonitor_t *monitor = (vmmonitor_t*)_monitor;
    if (monitor->checkword_start != 1234567 || monitor->checkword_end != 7654321) {
      fprintf(stderr, "invalid checkword");
      exit(1);
    }
...
extern "C" void
sysMonitorEnterDbg(Word _monitor)
{
    printf("sysMonitorEnterDbg...\n");
#ifdef RVM_FOR_HARMONY
    hythread_monitor_enter((hythread_monitor_t)_monitor);
#else
    vmmonitor_t *monitor = (vmmonitor_t*)_monitor;
...
extern "C" void
sysMonitorExitDbg(Word _monitor)
{
	printf("sysMonitorExitDbg...\n");
#ifdef RVM_FOR_HARMONY
    hythread_monitor_exit((hythread_monitor_t)_monitor);
#else
    vmmonitor_t *monitor = (vmmonitor_t*)_monitor;
...
extern "C" void
sysMonitorWaitDbg(Word _monitor)
{
    printf("sysMonitorWaitDbg...\n");
#ifdef RVM_FOR_HARMONY
...
extern "C" void
sysMonitorBroadcastDbg(Word _monitor)
{
    printf("sysMonitorBroadcastDbg...\n");
#ifdef RVM_FOR_HARMONY
...
checkMalloc(int length)
{
    ...
    //fprintf(stderr,"checkMalloc: %p -> %p\n", result, result+length);
    return result;
}
...
checkCalloc(int numElements, int sizeOfOneElement)
{
    ...
    //fprintf(stderr,"checkCalloc: %p -> %p\n", result, result+sizeOfOneElement);
    return result;
}
